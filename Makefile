...
COMPRESS      = gzip -9f
DISTNAME      = test21.0.0
DISTDIR = /home/avs-es/Documents/C++/pico-plotter/.tmp/test21.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -L. -lqcustomplot /usr/lib/x86_64-linux-gnu/libQt5Widgets.so /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.hpp $(DISTDIR)/
