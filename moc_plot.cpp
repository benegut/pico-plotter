...
QT_MOC_LITERAL(3, 17, 21), // "send_Unit_Data_Signal"
QT_MOC_LITERAL(4, 39, 4), // "UNIT"
QT_MOC_LITERAL(5, 44, 18), // "get_Unit_Data_Slot"
QT_MOC_LITERAL(6, 63, 17) // "streamDataHandler"

    },
    "Worker\0sendData\0\0send_Unit_Data_Signal\0"
    "UNIT\0get_Unit_Data_Slot\0streamDataHandler"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Worker::*)(UNIT );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::send_Unit_Data_Signal)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Worker::send_Unit_Data_Signal(UNIT _t1)
{
